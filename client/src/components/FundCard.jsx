    ...
    return (
        <div className='sm:w-[288px] w-full rounded-[15px] bg-[#1c1c24] cursor-pointer' onClick={handleClick}>
            <img
                src={image}
                alt={`image for ${title}`}
                className='w-full rounded-[15px] h-[155px] object-cover'
            />
            ...
            <div className='flex flex-col p-4'>
                ...
                <div className='block'>
                    <h3 className='font-epilogue font-semibold text-[16px] text-white text-left leading-[26px]'>{title}</h3>
                    <p className='font-epilogue font-semibold text-[16px] text-white text-left leading-[26px] truncate'>{description}</p>
                </div>
